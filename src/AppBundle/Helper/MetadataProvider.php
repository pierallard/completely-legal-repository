...
class MetadataProvider
{
    ...
    public function getMetadata(Client $client, $token)
    {
        if (null === $this->metadata) {
            $this->generateCategoryContent($client, $token);
            $this->generateTermContent($client, $token);
     ...
     * @param $token
     */
    private function generateCategoryContent(Client $client, $token)
    {
     ...
     * @param $token
     */
    private function generateTermContent(Client $client, $token)
    {
